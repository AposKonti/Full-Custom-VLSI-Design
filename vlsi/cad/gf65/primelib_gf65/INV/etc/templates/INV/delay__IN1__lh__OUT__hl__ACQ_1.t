...
# Host Name: engnx03a.utdallas.edu, User Name: axk220238, PID: 22896 #
# Directory: /home/eng/a/axk220238/vlsi/cad/gf65/primelib_gf65_axk220238_axk230133 #
# Date Thu, 30 Nov 2023 18:30:31 CST #
#                                                                            #
...
## 
## Formal Ports
$tempTestColl makeFormalPorts {OUT VSS IN1 VDD}
...
$tempWT setInterface { IN1 OUT:inout } { initial_delay units ct default_slew pp energy_change_threshold energy_change_abs_threshold }

$tempWT setStimulus                  {   IN1  OUT   } {
                   "0"            {} {   0    Z,1   }
...
$tempWT bindInterface { IN1 OUT } { 10e-12 IN1[cycle_time] IN1[cycle_time] IN1[default_slew] cell_power_period power_stabilization_threshold power_stabilization_threshold_absolute }
