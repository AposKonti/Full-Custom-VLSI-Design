if { [catch {
set_location /home/eng/a/axk220238/vlsi/cad/gf65/primelib_gf65_axk220238_axk230133/NAND
log_info "[clock format [clock seconds]]: Sourcing environment settings"
set t0 [clock seconds]
set sis_log_file "/var/tmp/pl.786799.W$::env(CDPL_WORKERID).[lindex [split [info hostname] '.'] 0].[pid].log"
if { [info exists ::env(SGE_TASK_ID)] } {
  if { $::env(SGE_TASK_ID) != "undefined" } {
    set sis_log_file "/var/tmp/pl.786799.W$::env(SGE_TASK_ID).[lindex [split [info hostname] '.'] 0].[pid].log"
  }
}
...
set_config_opt -- cdpl_log_subdir pid28071

create_parameter configure_arc_based
set_config_opt -cell NAND -- configure_arc_based 0
...
if {[catch {
  ...
  reset_log_file
  if { [log_num_errors] > 0 } {
    if { [catch {exec mv -f $sis_log_file /home/eng/a/axk220238/vlsi/cad/gf65/primelib_gf65_axk220238_axk230133/NAND/runtime/cdpl/pid28071} mv_err] } {
      log_warning $mv_err
    }
  } else {
