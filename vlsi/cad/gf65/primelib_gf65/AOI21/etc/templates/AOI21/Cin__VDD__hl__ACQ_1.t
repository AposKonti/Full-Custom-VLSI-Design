...
$tempAcq setState "!IN1&!IN2&!IN3&!OUT&!VSS"
$tempAcq setStateCoverage "1"

## 
## Wavetable
set tempWT [ SBWaveTable ]
$tempWT setInterface { VSS IN3 IN1 IN2 VDD } { initial_delay units ct default_slew pp }

$tempWT setStimulus            {   VSS  IN3  IN1  IN2  VDD   } {
                   "0"      {} {   0    0    0    0    1     }
       "initial_delay" { in1 } {   -    -    -    -    0     }
"(initial_delay)+(pp)"      {} {   -    -    -    -    -     }
}
...
$tempWT bindInterface { VSS IN3 IN1 IN2 VDD } { 10e-12 VDD[cycle_time] VDD[cycle_time] VDD[default_slew] cell_power_period }
