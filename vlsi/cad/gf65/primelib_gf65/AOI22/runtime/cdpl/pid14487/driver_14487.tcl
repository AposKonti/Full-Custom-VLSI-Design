if { [catch {
set_location /home/eng/a/axk220238/vlsi/cad/gf65/primelib_gf65_axk220238_axk230133/AOI22
...
set_config_opt -- cdpl_log_subdir pid14487
...
if {[catch {
  ...
  reset_log_file
  if { [log_num_errors] > 0 } {
    if { [catch {exec mv -f $sis_log_file /home/eng/a/axk220238/vlsi/cad/gf65/primelib_gf65_axk220238_axk230133/AOI22/runtime/cdpl/pid14487} mv_err] } {
      log_warning $mv_err
    }
  } else {
