...
## 
## Test delay__IN3__hl__OUT__lh
set tempTest [ SBTest "delay__IN3__hl__OUT__lh" ]
$tempTest setTargets { delay__IN3__hl__OUT__lh Cin__IN3__hl Tout__OUT__lh cap_energy__OUT__lh energy1__IN3__hl__OUT__lh__VDD energy__IN3__hl__OUT__lh leakage_power1__VDD leakage_power2__VDD }
...
$tempAcq setState "IN4&!IN1&!IN2"
$tempAcq setStateCoverage "1"
$tempAcq setAdditionalStateCoverage "1" "energy__IN3__hl__OUT__lh"
$tempAcq setAdditionalStateCoverage "1" "energy1__IN3__hl__OUT__lh__VDD"
...
$tempWT addMeasurements {} {
  { tin_IN3              Tin        { IN3 start } NO_USER SYS }
  { cin_IN3              Cin        { IN3 start } NO_USER SYS }
  { tout_OUT             Tout       { OUT out } NO_USER SYS }
  { delay_IN3_OUT        delay      { IN3 start OUT out } NO_USER SYS }
  { energy__IN3__hl__OUT__lh energy     { start pp energy_change_threshold energy_change_abs_threshold 0 } NO_USER SYS }
  { cell_power_period    export_expr { pp } }
  { energy1__IN3__hl__OUT__lh__VDD energy1    { start pp energy_change_threshold energy_change_abs_threshold 0 VDD } }
...
$tempWT bindInterface { IN4 IN3 IN1 IN2 OUT } { 10e-12 IN3[cycle_time] IN3[cycle_time] IN3[default_slew] cell_power_period power_stabilization_threshold power_stabilization_threshold_absolute }
