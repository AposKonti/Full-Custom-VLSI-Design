...
$tempAcq setState "!IN1&!IN2&!IN3&OUT"
$tempAcq setStateCoverage "1"

## 
## Wavetable
set tempWT [ SBWaveTable ]
$tempWT setInterface { IN3 IN1 IN2 OUT:out } { initial_delay units ct default_slew gate_leakage_multiplication_factor trailing_delay pp }
...
$tempWT addMeasurements {} {
  { leakage_current      leakage_power { (0)+initial_delay+(gate_leakage_multiplication_factor*pp) (0)+initial_delay+(gate_leakage_multiplication_factor*pp)+pp {IN1 IN2 IN3} {} } NO_USER SYS }
}

$tempWT bindInterface { IN3 IN1 IN2 OUT } { cell_initial_delay None[cycle_time] None[cycle_time] None[default_slew] gate_leakage_time_scaling_factor cell_trailing_delay cell_power_period }
