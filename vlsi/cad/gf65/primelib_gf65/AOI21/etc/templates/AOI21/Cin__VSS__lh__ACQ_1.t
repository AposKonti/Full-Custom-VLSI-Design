...
$tempAcq setState "!IN1&!IN2&!IN3&!OUT&!VDD"
$tempAcq setStateCoverage "1"

## 
## Wavetable
set tempWT [ SBWaveTable ]
$tempWT setInterface { IN1 VSS VDD IN2 IN3 } { initial_delay units ct default_slew pp }

$tempWT setStimulus            {   IN1  VSS  VDD  IN2  IN3   } {
                   "0"      {} {   0    0    0    0    0     }
       "initial_delay" { in1 } {   -    1    -    -    -     }
"(initial_delay)+(pp)"      {} {   -    -    -    -    -     }
}
...
$tempWT bindInterface { IN1 VSS VDD IN2 IN3 } { 10e-12 VSS[cycle_time] VSS[cycle_time] VSS[default_slew] cell_power_period }
