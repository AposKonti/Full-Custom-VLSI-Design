...
# Date Thu, 30 Nov 2023 18:27:05 CST #
#                                                                            #
...
## 
## Formal Ports
$tempTestColl makeFormalPorts {VSS IN1 IN2 IN3 VDD OUT}
...
$tempWT setInterface { IN3 IN1 IN2 OUT:inout } { initial_delay units ct default_slew pp energy_change_threshold energy_change_abs_threshold }

$tempWT setStimulus                  {   IN3  IN1  IN2  OUT   } {
                   "0"            {} {   0    0    0    Z,1   }
...
$tempWT bindInterface { IN3 IN1 IN2 OUT } { 10e-12 IN3[cycle_time] IN3[cycle_time] IN3[default_slew] cell_power_period power_stabilization_threshold power_stabilization_threshold_absolute }
