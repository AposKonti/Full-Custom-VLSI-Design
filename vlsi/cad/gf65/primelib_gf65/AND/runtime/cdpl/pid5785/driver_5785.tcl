if { [catch {
set_location /home/eng/a/axk220238/vlsi/cad/gf65/primelib_gf65_axk220238_axk230133/AND
...
set_config_opt -- cdpl_log_subdir pid5785

create_parameter configure_arc_based
set_config_opt -cell AND -- configure_arc_based 0
...
if {[catch {
  ...
  reset_log_file
  if { [log_num_errors] > 0 } {
    if { [catch {exec mv -f $sis_log_file /home/eng/a/axk220238/vlsi/cad/gf65/primelib_gf65_axk220238_axk230133/AND/runtime/cdpl/pid5785} mv_err] } {
      log_warning $mv_err
    }
  } else {
