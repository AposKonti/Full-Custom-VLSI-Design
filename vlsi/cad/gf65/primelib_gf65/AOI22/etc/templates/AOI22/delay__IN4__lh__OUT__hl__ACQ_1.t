...
## 
## Test delay__IN4__lh__OUT__hl
set tempTest [ SBTest "delay__IN4__lh__OUT__hl" ]
$tempTest setTargets { delay__IN4__lh__OUT__hl Cin__IN4__lh Tout__OUT__hl cap_energy__OUT__hl energy1__IN4__lh__OUT__hl__VDD energy__IN4__lh__OUT__hl leakage_power1__VDD leakage_power2__VDD }
...
$tempAcq setState "IN3&!IN1&!IN2"
$tempAcq setStateCoverage "1"
$tempAcq setAdditionalStateCoverage "1" "leakage_power1__VDD"
$tempAcq setAdditionalStateCoverage "1" "energy1__IN4__lh__OUT__hl__VDD"
$tempAcq setAdditionalStateCoverage "1" "energy__IN4__lh__OUT__hl"
...
$tempWT setInterface { IN4 IN3 IN1 IN2 OUT:inout } { initial_delay units ct default_slew pp energy_change_threshold energy_change_abs_threshold }

$tempWT setStimulus                  {   IN4  IN3  IN1  IN2  OUT   } {
                   "0"            {} {   0    1    0    0    Z,1   }
...
$tempWT addMeasurements {} {
  { tin_IN4              Tin        { IN4 start } NO_USER SYS }
  { cin_IN4              Cin        { IN4 start } NO_USER SYS }
  { tout_OUT             Tout       { OUT out } NO_USER SYS }
  { delay_IN4_OUT        delay      { IN4 start OUT out } NO_USER SYS }
  { energy__IN4__lh__OUT__hl energy     { start pp energy_change_threshold energy_change_abs_threshold 0 } NO_USER SYS }
  { cell_power_period    export_expr { pp } }
  { energy1__IN4__lh__OUT__hl__VDD energy1    { start pp energy_change_threshold energy_change_abs_threshold 0 VDD } }
...
$tempWT bindInterface { IN4 IN3 IN1 IN2 OUT } { 10e-12 IN4[cycle_time] IN4[cycle_time] IN4[default_slew] cell_power_period power_stabilization_threshold power_stabilization_threshold_absolute }
