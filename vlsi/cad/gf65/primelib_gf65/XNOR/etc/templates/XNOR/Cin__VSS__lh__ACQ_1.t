...
$tempAcq setState "!IN1&!IN2&!OUT&!VDD"
$tempAcq setStateCoverage "1"

## 
## Wavetable
set tempWT [ SBWaveTable ]
$tempWT setInterface { VSS IN1 IN2 VDD } { initial_delay units ct default_slew pp }

$tempWT setStimulus            {   VSS  IN1  IN2  VDD   } {
                   "0"      {} {   0    0    0    0     }
       "initial_delay" { in1 } {   1    -    -    -     }
"(initial_delay)+(pp)"      {} {   -    -    -    -     }
}
...
$tempWT bindInterface { VSS IN1 IN2 VDD } { 10e-12 VSS[cycle_time] VSS[cycle_time] VSS[default_slew] cell_power_period }
